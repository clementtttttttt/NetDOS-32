...
enum opt_code
{
  ...
  OPT_march_ = 1616,                         /* -march= */
  OPT_masm_ = 1617,                          /* -masm= */
  OPT_mavx = 1618,                           /* -mavx */
  OPT_mavx2 = 1619,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1620,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1621,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1622,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1623,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1624,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1625,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1626,                      /* -mavx512bw */
  OPT_mavx512cd = 1627,                      /* -mavx512cd */
  OPT_mavx512dq = 1628,                      /* -mavx512dq */
  OPT_mavx512er = 1629,                      /* -mavx512er */
  OPT_mavx512f = 1630,                       /* -mavx512f */
  OPT_mavx512ifma = 1631,                    /* -mavx512ifma */
  OPT_mavx512pf = 1632,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1633,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1634,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1635,                      /* -mavx512vl */
  OPT_mavx512vnni = 1636,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1637,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1638,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1639,                           /* -mbmi */
  OPT_mbmi2 = 1640,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1641,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1642,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1643,                    /* -mcet-switch */
  OPT_mcld = 1644,                           /* -mcld */
  OPT_mcldemote = 1645,                      /* -mcldemote */
  OPT_mclflushopt = 1646,                    /* -mclflushopt */
  OPT_mclwb = 1647,                          /* -mclwb */
  OPT_mclzero = 1648,                        /* -mclzero */
  OPT_mcmodel_ = 1649,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1650, */                    /* -mcpu= */
  OPT_mcrc32 = 1651,                         /* -mcrc32 */
  OPT_mcx16 = 1652,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1653,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1654,            /* -mdump-tune-features */
  OPT_menqcmd = 1655,                        /* -menqcmd */
  OPT_mf16c = 1656,                          /* -mf16c */
  OPT_mfancy_math_387 = 1657,                /* -mfancy-math-387 */
  OPT_mfentry = 1658,                        /* -mfentry */
  OPT_mfentry_name_ = 1659,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1660,               /* -mfentry-section= */
  OPT_mfma = 1661,                           /* -mfma */
  OPT_mfma4 = 1662,                          /* -mfma4 */
  OPT_mforce_drap = 1663,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1664,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1665,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1666,                       /* -mfpmath= */
  OPT_mfsgsbase = 1667,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1668,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1669, */              /* -mfused-madd */
  OPT_mfxsr = 1670,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1671,             /* -mgeneral-regs-only */
  OPT_mgfni = 1672,                          /* -mgfni */
  OPT_mhard_float = 1673,                    /* -mhard-float */
  OPT_mhle = 1674,                           /* -mhle */
  OPT_miamcu = 1675,                         /* -miamcu */
  OPT_mieee_fp = 1676,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1677,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1678,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1679,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1680,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1681,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1682,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1683, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1684,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1685,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1686,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1687,                /* -mlong-double-80 */
  OPT_mlwp = 1688,                           /* -mlwp */
  OPT_mlzcnt = 1689,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1690,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1691,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1692,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1693,                  /* -mmitigate-rop */
  OPT_mmmx = 1694,                           /* -mmmx */
  OPT_mmovbe = 1695,                         /* -mmovbe */
  OPT_mmovdir64b = 1696,                     /* -mmovdir64b */
  OPT_mmovdiri = 1697,                       /* -mmovdiri */
  OPT_mmpx = 1698,                           /* -mmpx */
  OPT_mms_bitfields = 1699,                  /* -mms-bitfields */
  OPT_mmwaitx = 1700,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1701,            /* -mno-align-stringops */
  OPT_mno_default = 1702,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1703,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1704,                  /* -mno-push-args */
  OPT_mno_red_zone = 1705,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1706,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1707,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1708,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1709,                          /* -mpc32 */
  OPT_mpc64 = 1710,                          /* -mpc64 */
  OPT_mpc80 = 1711,                          /* -mpc80 */
  OPT_mpclmul = 1712,                        /* -mpclmul */
  OPT_mpcommit = 1713,                       /* -mpcommit */
  OPT_mpconfig = 1714,                       /* -mpconfig */
  OPT_mpku = 1715,                           /* -mpku */
  OPT_mpopcnt = 1716,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1717, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1718,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1719,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1720,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1721,                        /* -mprfchw */
  OPT_mptwrite = 1722,                       /* -mptwrite */
  OPT_mpush_args = 1723,                     /* -mpush-args */
  OPT_mrdpid = 1724,                         /* -mrdpid */
  OPT_mrdrnd = 1725,                         /* -mrdrnd */
  OPT_mrdseed = 1726,                        /* -mrdseed */
  OPT_mrecip = 1727,                         /* -mrecip */
  OPT_mrecip_ = 1728,                        /* -mrecip= */
  OPT_mrecord_mcount = 1729,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1730,                 /* -mrecord-return */
  OPT_mred_zone = 1731,                      /* -mred-zone */
  OPT_mregparm_ = 1732,                      /* -mregparm= */
  OPT_mrtd = 1733,                           /* -mrtd */
  OPT_mrtm = 1734,                           /* -mrtm */
  OPT_msahf = 1735,                          /* -msahf */
  OPT_msgx = 1736,                           /* -msgx */
  OPT_msha = 1737,                           /* -msha */
  OPT_mshstk = 1738,                         /* -mshstk */
  OPT_mskip_rax_setup = 1739,                /* -mskip-rax-setup */
  OPT_msoft_float = 1740,                    /* -msoft-float */
  OPT_msse = 1741,                           /* -msse */
  OPT_msse2 = 1742,                          /* -msse2 */
  OPT_msse2avx = 1743,                       /* -msse2avx */
  OPT_msse3 = 1744,                          /* -msse3 */
  OPT_msse4 = 1745,                          /* -msse4 */
  OPT_msse4_1 = 1746,                        /* -msse4.1 */
  OPT_msse4_2 = 1747,                        /* -msse4.2 */
  OPT_msse4a = 1748,                         /* -msse4a */
  /* OPT_msse5 = 1749, */                    /* -msse5 */
  OPT_msseregparm = 1750,                    /* -msseregparm */
  OPT_mssse3 = 1751,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1752,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1753, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1754,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1755, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1756,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1757,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1758,            /* -mstringop-strategy= */
  OPT_mstv = 1759,                           /* -mstv */
  OPT_mtbm = 1760,                           /* -mtbm */
  OPT_mtls_dialect_ = 1761,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1762,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1763,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1764,                         /* -mtune= */
  OPT_mvaes = 1765,                          /* -mvaes */
  OPT_mveclibabi_ = 1766,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1767,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1768,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1769,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1770,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1771,                      /* -mwbnoinvd */
  OPT_mx32 = 1772,                           /* -mx32 */
  OPT_mxop = 1773,                           /* -mxop */
  OPT_mxsave = 1774,                         /* -mxsave */
  OPT_mxsavec = 1775,                        /* -mxsavec */
  OPT_mxsaveopt = 1776,                      /* -mxsaveopt */
  OPT_mxsaves = 1777,                        /* -mxsaves */
  OPT_n = 1778,                              /* -n */
  OPT_name_sort = 1779,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1780,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1781,              /* -no-integrated-cpp */
  OPT_no_pie = 1782,                         /* -no-pie */
  OPT_nocpp = 1783,                          /* -nocpp */
  OPT_nodefaultlibs = 1784,                  /* -nodefaultlibs */
  OPT_nolibc = 1785,                         /* -nolibc */
  OPT_nophoboslib = 1786,                    /* -nophoboslib */
  OPT_nostartfiles = 1787,                   /* -nostartfiles */
  OPT_nostdinc = 1788,                       /* -nostdinc */
  OPT_nostdinc__ = 1789,                     /* -nostdinc++ */
  OPT_nostdlib = 1790,                       /* -nostdlib */
  OPT_o = 1791,                              /* -o */
  OPT_objects = 1792,                        /* -objects */
  OPT_p = 1793,                              /* -p */
  OPT_pass_exit_codes = 1794,                /* -pass-exit-codes */
  /* OPT_pedantic = 1795, */                 /* -pedantic */
  OPT_pedantic_errors = 1796,                /* -pedantic-errors */
  OPT_pg = 1797,                             /* -pg */
  OPT_pie = 1798,                            /* -pie */
  OPT_pipe = 1799,                           /* -pipe */
  OPT_print_file_name_ = 1800,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1801,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1802,          /* -print-multi-directory */
  OPT_print_multi_lib = 1803,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1804,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1805,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1806,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1807,               /* -print-prog-name= */
  OPT_print_search_dirs = 1808,              /* -print-search-dirs */
  OPT_print_sysroot = 1809,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1810,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1811,                    /* -print-value */
  OPT_quiet = 1812,                          /* -quiet */
  OPT_r = 1813,                              /* -r */
  OPT_remap = 1814,                          /* -remap */
  OPT_reverse_sort = 1815,                   /* -reverse-sort */
  OPT_s = 1816,                              /* -s */
  OPT_save_temps = 1817,                     /* -save-temps */
  OPT_save_temps_ = 1818,                    /* -save-temps= */
  OPT_shared = 1819,                         /* -shared */
  OPT_shared_libgcc = 1820,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1821,               /* -shared-libphobos */
  OPT_size_sort = 1822,                      /* -size-sort */
  /* OPT_specs = 1823, */                    /* -specs */
  OPT_specs_ = 1824,                         /* -specs= */
  OPT_static = 1825,                         /* -static */
  OPT_static_libasan = 1826,                 /* -static-libasan */
  OPT_static_libgcc = 1827,                  /* -static-libgcc */
  OPT_static_libgfortran = 1828,             /* -static-libgfortran */
  OPT_static_libgo = 1829,                   /* -static-libgo */
  OPT_static_liblsan = 1830,                 /* -static-liblsan */
  OPT_static_libmpx = 1831,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1832,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1833,               /* -static-libphobos */
  OPT_static_libstdc__ = 1834,               /* -static-libstdc++ */
  OPT_static_libtsan = 1835,                 /* -static-libtsan */
  OPT_static_libubsan = 1836,                /* -static-libubsan */
  OPT_static_pie = 1837,                     /* -static-pie */
  /* OPT_std_c__03 = 1838, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1839, */                /* -std=c++0x */
  OPT_std_c__11 = 1840,                      /* -std=c++11 */
  OPT_std_c__14 = 1841,                      /* -std=c++14 */
  OPT_std_c__17 = 1842,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1843, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1844, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1845, */                /* -std=c++20 */
  OPT_std_c__2a = 1846,                      /* -std=c++2a */
  ...
  OPT_std_gnu__2a = 1871,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1872,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1873,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1874,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1875, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1876, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1877,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1878, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1879,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1880,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1881, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1882, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1883,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1884, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1885, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1886, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1887, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1888, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1889,                     /* -std=legacy */
  OPT_symbol_ = 1890,                        /* -symbol= */
  OPT_symbolic = 1891,                       /* -symbolic */
  OPT_t = 1892,                              /* -t */
  OPT_time = 1893,                           /* -time */
  OPT_time_ = 1894,                          /* -time= */
  OPT_traditional = 1895,                    /* -traditional */
  OPT_traditional_cpp = 1896,                /* -traditional-cpp */
  OPT_tree_stats = 1897,                     /* -tree-stats */
  OPT_trigraphs = 1898,                      /* -trigraphs */
  OPT_type_stats = 1899,                     /* -type-stats */
  OPT_u = 1900,                              /* -u */
  OPT_undef = 1901,                          /* -undef */
  OPT_v = 1902,                              /* -v */
  OPT_version = 1903,                        /* -version */
  OPT_w = 1904,                              /* -w */
  OPT_wrapper = 1905,                        /* -wrapper */
  OPT_x = 1906,                              /* -x */
  OPT_z = 1907,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
